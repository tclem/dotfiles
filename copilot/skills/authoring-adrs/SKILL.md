...
Skip for: routine refactors, bugfixes, dependency bumps, subsystem-internal design choices (write a design doc — see `authoring-design-docs`), or choices likely revisited within months.
...
- Design doc = subsystem shape (see `authoring-design-docs`).
